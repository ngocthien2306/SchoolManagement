...
namespace School_Management.Manager.Student
{
    partial class Manager_General
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.splitContainerControl1.Panel1.Controls.Add(this.Picture_Student);
            this.splitContainerControl1.Panel1.Controls.Add(this.GroupPage);
            this.splitContainerControl1.Panel1.Controls.Add(this.Lastname);
            this.splitContainerControl1.Panel1.Controls.Add(this.Firstname);
            this.splitContainerControl1.Panel1.Controls.Add(this.ID_student);
            this.splitContainerControl1.Panel1.Controls.Add(this.Lname_lb);
            this.splitContainerControl1.Panel1.Controls.Add(this.Fname_lb);
            this.splitContainerControl1.Panel1.Controls.Add(this.IdStudent_lb);
